...
# regardless of that choice (labgrid_toolkit_core, the app's own
...
def test_resolve_backend_module_finds_the_installed_backend(
    ...
    monkeypatch.setattr(backends, "_BACKENDS", {"fake": "labgrid_toolkit_core"})

    assert backends.resolve_backend_module() == "labgrid_toolkit_core"
